...
$js_dir = array_diff(scandir(PATH_ROOT.'/js/build'), array('..', '.'));
// Minify CSS
$css_minifier = new CSSminifierExtended();
$css_dir = array_diff(scandir(PATH_ROOT.'/css/build'), array('..', '.'));
// get customized ui data
$UI_TEXTS = customize('get', 'ui_texts');


// minify bootstrap theme
if (file_exists(PATH_ROOT.'/css/themes/'.$UI_THEME.'-bootstrap.css'))
  $css_minifier->add(PATH_ROOT.'/css/themes/'.$UI_THEME.'-bootstrap.css');
else
  $css_minifier->add(PATH_ROOT.'/css/themes/lumen-bootstrap.css'); 
// minify css build files
foreach ($css_dir as $css_file) {
  $css_minifier->add(PATH_ROOT.'/css/build/' . $css_file);
}
// minify js build files
foreach ($js_dir as $js_file) {
  $js_minifier->add(PATH_ROOT.'/js/build/' . $js_file);
}
